...
| 18 | `VarField_tcozone` | `TCozone(:)` | total column ozone (Du) | `MetaData/total_column_ozone` |  |
...
| 34 | `VarField_iremiss` | `IREmiss(:)` | surface emissivity (satellite 1dvar) | 'Emiss/ir_emissivity' | |
