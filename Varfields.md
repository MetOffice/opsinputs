...
| 35 | `VarField_cloudtopp` | `CloudTopP(:)` | retrieved cloud top pressure | `OneDVar/cloud_top_pressure` | |
| 36 | `VarField_cloudfrac` | `CloudFrac(:)` | retrieved cloud fraction | `OneDVar/cloud_fraction` | |
