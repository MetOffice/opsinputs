...
subroutine opsinputs_fill_fillelementtype2dfromsimulatedvariable_records( &
  Hdr, OpsVarName, JediToOpsLayoutMapping, El2, ObsSpace, Flags, ObsErrors, VarobsLength, JediVarName, JediGroupName, PackPGEs)
implicit none
...
subroutine opsinputs_fill_fillelementtype2dfromsimulatedvariable( &
  Hdr, OpsVarName, JediToOpsLayoutMapping, El2, ObsSpace, Channels, Flags, ObsErrors, VarobsLength, JediVarName, &
...
if (JediToOpsLayoutMapping % ConvertRecordsToMultilevelObs) then
  call opsinputs_fill_fillelementtype2dfromsimulatedvariable_records( &
    ...
    ObsErrors, VarobsLength, JediVarName, JediGroupName, PackPGEs)
else
...
if (JediToOpsLayoutMapping % ConvertRecordsToMultiLevelObs) then
  print *, "Using opsinputs_fill_fillrealfromgeovalformultilevelobs. JediVarName:", JediVarName
  print *, "JediToOpsLayoutMapping % NumOpsObs:", JediToOpsLayoutMapping % NumOpsObs
   call opsinputs_fill_fillrealfromgeovalformultilevelobs( &
    ...
    print *, "Retieving geoval directly. JediVarName:", JediVarName
    print *, "JediToOpsLayoutMapping % NumOpsObs:", JediToOpsLayoutMapping % NumOpsObs
    ...
    if (JediVarName == "aerosol") then
      ! print GeoVal % vals(1,1) to GeoVal % vals(70,1)
      print *, "GeoVal % vals(1,1):", GeoVal % vals(1,1)
      print *, "GeoVal % vals(2,1):", GeoVal % vals(2,1)
      print *, "GeoVal % vals(3,1):", GeoVal % vals(3,1)
      print *, "GeoVal % vals(4,1):", GeoVal % vals(4,1)
      print *, "GeoVal % vals(5,1):", GeoVal % vals(5,1)
      print *, "GeoVal % vals(6,1):", GeoVal % vals(6,1)
      print *, "GeoVal % vals(7,1):", GeoVal % vals(7,1)
      print *, "GeoVal % vals(8,1):", GeoVal % vals(8,1)
      print *, "GeoVal % vals(9,1):", GeoVal % vals(9,1)
      print *, "GeoVal % vals(10,1):", GeoVal % vals(10,1)
      print *, "GeoVal % vals(11,1):", GeoVal % vals(11,1)
      print *, "GeoVal % vals(12,1):", GeoVal % vals(12,1)
      print *, "GeoVal % vals(13,1):", GeoVal % vals(13,1)
      print *, "GeoVal % vals(14,1):", GeoVal % vals(14,1)
      print *, "GeoVal % vals(15,1):", GeoVal % vals(15,1)
      print *, "GeoVal % vals(16,1):", GeoVal % vals(16,1)
      print *, "GeoVal % vals(17,1):", GeoVal % vals(17,1)
      print *, "GeoVal % vals(18,1):", GeoVal % vals(18,1)
      print *, "GeoVal % vals(19,1):", GeoVal % vals(19,1)
      print *, "GeoVal % vals(20,1):", GeoVal % vals(20,1)
      print *, "GeoVal % vals(21,1):", GeoVal % vals(21,1)
      print *, "GeoVal % vals(22,1):", GeoVal % vals(22,1)
      print *, "GeoVal % vals(23,1):", GeoVal % vals(23,1)
      print *, "GeoVal % vals(24,1):", GeoVal % vals(24,1)
      print *, "GeoVal % vals(25,1):", GeoVal % vals(25,1)
      print *, "GeoVal % vals(26,1):", GeoVal % vals(26,1)
      print *, "GeoVal % vals(27,1):", GeoVal % vals(27,1)
      print *, "GeoVal % vals(28,1):", GeoVal % vals(28,1)
      print *, "GeoVal % vals(29,1):", GeoVal % vals(29,1)
      print *, "GeoVal % vals(30,1):", GeoVal % vals(30,1)
      print *, "GeoVal % vals(31,1):", GeoVal % vals(31,1)
      print *, "GeoVal % vals(32,1):", GeoVal % vals(32,1)
      print *, "GeoVal % vals(33,1):", GeoVal % vals(33,1)
      print *, "GeoVal % vals(34,1):", GeoVal % vals(34,1)
      print *, "GeoVal % vals(35,1):", GeoVal % vals(35,1)
      print *, "GeoVal % vals(36,1):", GeoVal % vals(36,1)
      print *, "GeoVal % vals(37,1):", GeoVal % vals(37,1)
      print *, "GeoVal % vals(38,1):", GeoVal % vals(38,1)
      print *, "GeoVal % vals(39,1):", GeoVal % vals(39,1)
      print *, "GeoVal % vals(40,1):", GeoVal % vals(40,1)
      print *, "GeoVal % vals(41,1):", GeoVal % vals(41,1)
      print *, "GeoVal % vals(42,1):", GeoVal % vals(42,1)
      print *, "GeoVal % vals(43,1):", GeoVal % vals(43,1)
      print *, "GeoVal % vals(44,1):", GeoVal % vals(44,1)
      print *, "GeoVal % vals(45,1):", GeoVal % vals(45,1)
      print *, "GeoVal % vals(46,1):", GeoVal % vals(46,1)
      print *, "GeoVal % vals(47,1):", GeoVal % vals(47,1)
      print *, "GeoVal % vals(48,1):", GeoVal % vals(48,1)
      print *, "GeoVal % vals(49,1):", GeoVal % vals(49,1)
      print *, "GeoVal % vals(50,1):", GeoVal % vals(50,1)
      print *, "GeoVal % vals(51,1):", GeoVal % vals(51,1)
      print *, "GeoVal % vals(52,1):", GeoVal % vals(52,1)
      print *, "GeoVal % vals(53,1):", GeoVal % vals(53,1)
      print *, "GeoVal % vals(54,1):", GeoVal % vals(54,1)
      print *, "GeoVal % vals(55,1):", GeoVal % vals(55,1)
      print *, "GeoVal % vals(56,1):", GeoVal % vals(56,1)
      print *, "GeoVal % vals(57,1):", GeoVal % vals(57,1)
      print *, "GeoVal % vals(58,1):", GeoVal % vals(58,1)
      print *, "GeoVal % vals(59,1):", GeoVal % vals(59,1)
      print *, "GeoVal % vals(60,1):", GeoVal % vals(60,1)
      print *, "GeoVal % vals(61,1):", GeoVal % vals(61,1)
      print *, "GeoVal % vals(62,1):", GeoVal % vals(62,1)
      print *, "GeoVal % vals(63,1):", GeoVal % vals(63,1)
      print *, "GeoVal % vals(64,1):", GeoVal % vals(64,1)
      print *, "GeoVal % vals(65,1):", GeoVal % vals(65,1)
      print *, "GeoVal % vals(66,1):", GeoVal % vals(66,1)
      print *, "GeoVal % vals(67,1):", GeoVal % vals(67,1)
      print *, "GeoVal % vals(68,1):", GeoVal % vals(68,1)
      print *, "GeoVal % vals(69,1):", GeoVal % vals(69,1)
      print *, "GeoVal % vals(70,1):", GeoVal % vals(70,1)
...
hofxToCx = .false.
if (present(WriteHofXIntoCX)) then
   hofxToCx = WriteHofXIntoCX
end if
...
if (JediToOpsLayoutMapping % ConvertRecordsToMultiLevelObs) then
   ...
   do i = 1, size(hofx, 1)
      if (present(JediObsName)) then
         if (varnames % variable(i) == JediObsName) then
            hofxIndex = i
            exit
         end if
      else
   ...
   if (hofxIndex > 0 .and. hofxToCx) then
...
subroutine opsinputs_fill_filltimeoffsets2d_records( &
  Hdr, OpsVarName, JediToOpsLayoutMapping, Real2, ObsSpace, VarobsLength, JediVarName, JediVarGroup, ReferenceTime)
use datetime_mod, only: datetime
implicit none
...
subroutine opsinputs_fill_filltimeoffsets2d( &
  Hdr, OpsVarName, JediToOpsLayoutMapping, Real2, ObsSpace, Channels, VarobsLength, JediVarName, JediVarGroup, &
  ReferenceTime)
use datetime_mod, only: datetime
implicit none
...
if (JediToOpsLayoutMapping % ConvertRecordsToMultilevelObs) then
  call opsinputs_fill_filltimeoffsets2d_records(Hdr, OpsVarName, &
                                                ...
                                                ObsSpace, VarobsLength, JediVarName, JediVarGroup, &
                                                ReferenceTime)
else
