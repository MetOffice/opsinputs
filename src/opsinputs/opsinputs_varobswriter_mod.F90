  ...
  select case (VarFields(iVarField))
    ...
    case (VarField_britemp)
      call opsinputs_fill_fillreal2d( &
        ...
        ObsSpace, self % channels, self % varChannels, self % VarobsLength, "brightnessTemperature", "BiasCorrObsValue", &
    ...
    case (VarField_mwemiss)
      call opsinputs_fill_fillreal2d( &
        ...
        ObsSpace, self % channels, self % varChannels, self % VarobsLength, "emissivity", "Emiss")
    case (VarField_TCozone)
      call opsinputs_fill_fillreal( &
    ...
    case (VarField_Emissivity)
      call opsinputs_fill_fillreal2d( &
        ...
        ObsSpace, self % channels, self % varChannels, self % VarobsLength, "emissivity", "OneDVar", self % channel_offset)
    ...
    case (VarField_RadarObAzim)
      call opsinputs_fill_fillreal2d( &
        ...
        ObsSpace, self % channels, self % varChannels, self % VarobsLength, "radarAzimuth", "MetaData")
    ...
    case (VarField_BriTempVarError)
      call opsinputs_fill_fillreal2d( &
        ...
        ObsSpace, self % channels, self % varChannels, self % VarobsLength, "brightnessTemperature",&
    ...
    case (VarField_LevelLat)
      call opsinputs_fill_fillreal2d( &
        ...
        ObsSpace, self % channels, self % varChannels, self % VarobsLength, "latitude", "MetaData")
    case (VarField_LevelLon)
      call opsinputs_fill_fillreal2d( &
        Ob % Header % level_lon, "level_lon", JediToOpsLayoutMapping, Ob % level_lon, &
        ObsSpace, self % channels, self % varChannels, self % VarobsLength, "longitude", "MetaData")
