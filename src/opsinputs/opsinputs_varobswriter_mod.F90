  ...
  select case (VarFields(iVarField))
    ...
    case (VarField_theta)
      ...
      if (self % RequireTforTheta) then
         if (obsspace_has(ObsSpace, "ObsValue", "airTemperature")) then
            call opsinputs_fill_fillelementtype2dfromsimulatedvariable( &
                 ...
                 ObsSpace, self % channels, Flags, ObsErrors, self % IC_PLevels, "airTemperature", "ObsValue")
         else
     ...
     call opsinputs_fill_fillelementtype2dfromsimulatedvariable( &
          ...
          ObsSpace, self % channels, Flags, ObsErrors, self % IC_PLevels, "potentialTemperature", "ObsValue")
    ...
    case (VarField_rh)
      if (Ob % Header % ObsGroup == ObsGroupSurface) then
        ...
        call opsinputs_fill_fillelementtype2dfromsimulatedvariable( &
          ...
          ObsSpace, self % channels, Flags, ObsErrors, self % IC_PLevels, "relativeHumidity", "ObsValue")
      end if
    case (VarField_u)
      if (Ob % Header % ObsGroup == ObsGroupSurface .or. &
        ...
        call opsinputs_fill_fillelementtype2dfromsimulatedvariable( &
          ...
          ObsSpace, self % channels, Flags, ObsErrors, self % IC_PLevels, "windEastward", "ObsValue")
      end if
    case (VarField_v)
      if (Ob % Header % ObsGroup == ObsGroupSurface .or. &
          Ob % Header % ObsGroup == ObsGroupScatwind) then
        ...
        call opsinputs_fill_fillelementtype2dfromsimulatedvariable( &
          ...
          ObsSpace, self % channels, Flags, ObsErrors, self % IC_PLevels, "windNorthward", "ObsValue")
      end if
    ...
    case (VarField_britemp)
      call opsinputs_fill_fillreal2d( &
        ...
        ObsSpace, self % channels, "brightnessTemperature", "BiasCorrObsValue", self % channel_offset)
    case (VarField_tskin)
    ...
    case (VarField_mwemiss)
      call opsinputs_fill_fillreal2d( &
        ...
        ObsSpace, self % channels, "emissivity", "Emiss")
    case (VarField_TCozone)
      call opsinputs_fill_fillreal( &
    ...
    case (VarField_u10ambwind)
      call opsinputs_fill_fillelementtype2dfromsimulatedvariable( &
        ...
        ObsSpace, self % channels, Flags, ObsErrors, IC_PLevels, "windEastward", "BiasCorrObsValue")
    case (VarField_v10ambwind)
      call opsinputs_fill_fillelementtype2dfromsimulatedvariable( &
        Ob % Header % v10AmbWind, "v10AmbWind", JediToOpsLayoutMapping, Ob % v10AmbWind, &
        ObsSpace, self % channels, Flags, ObsErrors, IC_PLevels, "windNorthward", "BiasCorrObsValue")
    case (VarField_pcorrect)
      ...
      call opsinputs_fill_fillelementtype2dfromsimulatedvariable( &
        ...
        ObsSpace, self % channels, Flags, ObsErrors, IC_PLevels, "probability", "ObsValue", PackPGEs=.false.)
    ...
    case (VarField_Emissivity)
      call opsinputs_fill_fillreal2d( &
        ...
        ObsSpace, self % channels, "emissivity", "OneDVar", self % channel_offset)
    ...
    case (VarField_RadarObAzim)
      call opsinputs_fill_fillreal2d( &
        ...
        ObsSpace, self % channels, "radarAzimuth", "MetaData")
    ...
    case (VarField_BendingAngle)
      if (GPSRO_TPD) then
        ...
        call opsinputs_fill_fillelementtype2dfromsimulatedvariable( &
          ...
          ObsSpace, self % channels, Flags, ObsErrors, self % IC_PLevels, "bendingAngle", "ObsValue", PackPGEs=.false.)
      end if
    ...
    case (VarField_BriTempVarError)
      call opsinputs_fill_fillreal2d( &
        ...
        ObsSpace, self % channels, "brightnessTemperature", "ObsErrorData", self % channel_offset)
