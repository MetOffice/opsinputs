...
ScopedSetEnv::ScopedSetEnv(const std::map<std::string, std::string> &variableNamesAndValues) {
...
void ScopedSetEnv::set(const std::string &variableName, const std::string &value) {
