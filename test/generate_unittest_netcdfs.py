...
if __name__ == "__main__":
    ...
    output_2d_geoval_to_netcdf       ('water_vapor_mixing_ratio_wrt_moist_air_and_condensed_water', 'testinput/005_UpperAirCxField_q.nc4')
    ...
    # ABIClr
    output_full_cx_to_netcdf(['skin_temperature', 'ice_area_fraction', 'height_above_mean_sea_level_at_surface', 'air_pressure_at_surface', 'eastward_wind_at_10m',
                              'northward_wind_at_10m', 'surface_temperature', 'relative_humidity_at_2m', 'air_pressure_at_sea_level'],
                             ['air_potential_temperature', 'water_vapor_mixing_ratio_wrt_moist_air_and_condensed_water', 'cloud_ice_mixing_ratio_wrt_moist_air_and_condensed_water',
    ...
    output_full_cx_to_netcdf(['ice_area_fraction',
                             ...
                             ['eastward_wind', 'northward_wind', 'air_potential_temperature', 'water_vapor_mixing_ratio_wrt_moist_air_and_condensed_water',
    ...
    output_full_cx_to_netcdf(['height_above_mean_sea_level_at_surface',
                              ...
                              'ice_area_fraction',
                              'total_cloud_amount'],
                             ['air_potential_temperature', 'water_vapor_mixing_ratio_wrt_moist_air_and_condensed_water', 'air_pressure_levels', 'cloud_layer',
                              'cloud_ice_mixing_ratio_wrt_moist_air_and_condensed_water',
                              'cloud_liquid_water_mixing_ratio_wrt_moist_air_and_condensed_water'],
    ...
    output_full_cx_to_netcdf(['height_above_mean_sea_level_at_surface', 'air_pressure_at_surface', 'ice_area_fraction', 'total_cloud_amount'],
                             ['air_potential_temperature', 'water_vapor_mixing_ratio_wrt_moist_air_and_condensed_water', 'air_pressure_levels', 'cloud_ice_mixing_ratio_wrt_moist_air_and_condensed_water',
                              'cloud_liquid_water_mixing_ratio_wrt_moist_air_and_condensed_water',
    ...
    # GroundGPS
    output_full_cx_to_netcdf(['skin_temperature', 'ice_area_fraction', 'height_above_mean_sea_level_at_surface', 'air_pressure_at_surface', 'eastward_wind_at_10m',
                              'northward_wind_at_10m', 'surface_temperature', 'relative_humidity_at_2m'],
                             ['air_potential_temperature', 'water_vapor_mixing_ratio_wrt_moist_air_and_condensed_water', 'cloud_ice_mixing_ratio_wrt_moist_air_and_condensed_water',
                              'cloud_liquid_water_mixing_ratio_wrt_moist_air_and_condensed_water', 'air_pressure_levels',
                              'cloud_volume_fraction_in_atmosphere_layer', 'liquid_cloud_volume_fraction_in_atmosphere_layer', 'ice_cloud_volume_fraction_in_atmosphere_layer'],
    ...
    # Surface
    output_full_cx_to_netcdf(['skin_temperature', 'height_above_mean_sea_level_at_surface', 'air_pressure_at_surface', 'eastward_wind_at_10m',
                              'northward_wind_at_10m', 'surface_temperature', 'relative_humidity_at_2m'],
                             ['air_potential_temperature', 'water_vapor_mixing_ratio_wrt_moist_air_and_condensed_water', 'cloud_ice_mixing_ratio_wrt_moist_air_and_condensed_water',
                              'cloud_liquid_water_mixing_ratio_wrt_moist_air_and_condensed_water', 'air_pressure_levels',
                              'cloud_volume_fraction_in_atmosphere_layer', 'liquid_cloud_volume_fraction_in_atmosphere_layer', 'ice_cloud_volume_fraction_in_atmosphere_layer',
    ...
    # Surface - UKV
    output_full_cx_to_netcdf(['skin_temperature', 'height_above_mean_sea_level_at_surface', 'air_pressure_at_surface', 'eastward_wind_at_10m',
                              'northward_wind_at_10m', 'surface_temperature', 'relative_humidity_at_2m', 'visibility_1p5m','qt_1p5m'],
                             ['air_potential_temperature', 'water_vapor_mixing_ratio_wrt_moist_air_and_condensed_water', 'cloud_ice_mixing_ratio_wrt_moist_air_and_condensed_water',
                              'cloud_liquid_water_mixing_ratio_wrt_moist_air_and_condensed_water', 'air_pressure_levels',
                              'cloud_volume_fraction_in_atmosphere_layer', 'liquid_cloud_volume_fraction_in_atmosphere_layer', 'ice_cloud_volume_fraction_in_atmosphere_layer',
    ...
    output_full_cx_to_netcdf(['friction_velocity_over_water', 'ice_area_fraction', 'obukhov_length', 'relative_humidity_at_2m', 'skin_temperature',
                              'height_above_mean_sea_level_at_surface', 'air_pressure_at_surface', 'air_pressure_at_sea_level', 'surface_temperature',
                             ...
                             ['air_pressure_levels', 'cloud_volume_fraction_in_atmosphere_layer', 'ice_cloud_volume_fraction_in_atmosphere_layer',
                              ...
                              'water_vapor_mixing_ratio_wrt_moist_air_and_condensed_water', 'air_potential_temperature', 'eastward_wind', 'northward_wind'],
    ...
    # Screen
    output_full_cx_to_netcdf(['height_above_mean_sea_level_at_surface', 'skin_temperature', 'ice_area_fraction', 'air_pressure_at_surface',
                              'eastward_wind_at_10m', 'northward_wind_at_10m', 'surface_temperature', 'relative_humidity_at_2m',
                              'visibility_1p5m', 'total_cloud_amount', 'air_pressure_at_sea_level',
                              'surf_param_a', 'surf_param_b'],
                             ['air_potential_temperature', 'eastward_wind', 'northward_wind', 'water_vapor_mixing_ratio_wrt_moist_air_and_condensed_water',
    ...
    # Oceanwinds
    output_full_cx_to_netcdf(['skin_temperature', 'ice_area_fraction', 'height_above_mean_sea_level_at_surface', 'air_pressure_at_surface',
                              'eastward_wind_at_10m', 'northward_wind_at_10m'],
                             ['air_pressure_levels'],
    ...
    # Radar reflectivity - UKV
    output_full_cx_to_netcdf(['height_above_mean_sea_level_at_surface'],
                             ['air_potential_temperature', 'water_vapor_mixing_ratio_wrt_moist_air_and_condensed_water', 'air_pressure_levels',
                              'cloud_ice_mixing_ratio_wrt_moist_air_and_condensed_water',
                              'cloud_liquid_water_mixing_ratio_wrt_moist_air_and_condensed_water',
