...
def output_1d_normal_var_to_netcdf(var_name_and_group, file_name):
    f = netcdf.netcdf_file(file_name, 'w')
    ...
    var = f.createVariable(var_name_and_group, 'f', ('nlocs',))
...
def output_1d_normal_int_var_to_netcdf(var_name_and_group, file_name):
    f = netcdf.netcdf_file(file_name, 'w')
    ...
    var = f.createVariable(var_name_and_group, 'i', ('nlocs',))
    var[:] = [5, missing_int, 6, 7]
...
output_2d_simulated_var_to_netcdf('impact_param',               'testinput/072_VarField_impactparam.nc4')
