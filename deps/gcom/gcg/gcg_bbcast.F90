...
SUBROUTINE gcg_bbcast (msg, len1, send, gid, istat, sarr)
!     ******************************************************************
!     * Purpose:
!     *
!     *  Broadcast a byte array to every processor of a group.
!     *
!     * Input:
...
IF (istat  ==  -1) RETURN
RANK = istat
CALL mpl_bcast(sarr, len1, mpl_byte, RANK,                                     &
               igid, istat)
#endif

RETURN
END SUBROUTINE gcg_bbcast
