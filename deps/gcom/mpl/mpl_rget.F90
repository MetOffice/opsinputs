...
!     * Purpose:
!     *
!     *  Gets data from remote processor and associate a request handle
!     *
!     *  Output:  error, request
!     *
!     ******************************************************************

SUBROUTINE MPL_RGet (origin_addr, origin_count, origin_datatype,               &
...
CALL MPI_RGet(  origin_addr, l_origin_count, l_origin_datatype,                &
