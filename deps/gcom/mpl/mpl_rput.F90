...
!     * Purpose:
!     *
!     *  Puts data into a remote processor and associate a request handle
!     *
!     *  Output:  error, request
!     *
!     ******************************************************************

SUBROUTINE MPL_RPut (origin_addr, origin_count, origin_datatype,               &
...
CALL MPI_RPut( origin_addr, l_origin_count, l_origin_datatype,                 &
               l_target_rank, target_disp, l_target_count, l_target_datatype,  &
               l_win, l_request, l_error)
