...
SUBROUTINE gc_rsumr_kind32 (len1, nproc, istat, ssum)
!     ******************************************************************
!     * Purpose:
!     *
...
!     *
!     * NOTES:   This is the same as GC_RSUMR but is explicitly 32 bit
...
REAL (KIND=gc_real32)   :: ssum(len1)
REAL (KIND=gc_real32)   :: reduce_data_wrk(len1,nproc)
...
CALL mpl_gather(ssum, len1, mpl_real4, reduce_data_wrk, len1,                  &
                mpl_real4, gc__ionode, gc__my_mpi_comm_world,                  &
                istat)
...
CALL mpl_bcast(ssum, len1, mpl_real4, gc__ionode,                              &
...
RETURN
END SUBROUTINE gc_rsumr_kind32
