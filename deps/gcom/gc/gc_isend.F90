...
SUBROUTINE gc_isend (msg, len1, reci, istat, rarr, sarr)
!     ******************************************************************
!     * Purpose:
!     *
...
INTEGER (KIND=gc_int_kind) :: msg, len1, reci, istat, rarr(len1),              &
                              sarr(len1)
...
IF (reci  /=  me) THEN  ! If I'm not sending to myself
  CALL mpl_bsend(sarr, gc__isize*len1, mpl_byte, reci, msg,                    &
