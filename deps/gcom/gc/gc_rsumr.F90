...
SUBROUTINE gc_rsumr (len1, nproc, istat, ssum)
!     ******************************************************************
!     * Purpose:
!     *
...
REAL (KIND=gc_real_kind)   :: reduce_data_wrk(len1,nproc)
...
CALL mpl_gather(ssum, len1, mpl_real, reduce_data_wrk, len1,                   &
                mpl_real, gc__ionode, gc__my_mpi_comm_world,                   &
                istat)
...
CALL mpl_bcast(ssum, len1, mpl_real, gc__ionode,                               &
